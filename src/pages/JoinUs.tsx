        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Join Tech Hub</h1>
                ...
                <div className="md:w-1/2 p-10">
                  ...
                  <div className="space-y-6">
                    <Button 
                      ...
                      className="w-full bg-green-500 hover:bg-green-600 py-6 text-lg flex items-center justify-center"
                    >
                    ...
                    <Button 
                      variant="outline"
                      className="w-full border-techhub-purple text-techhub-purple hover:bg-techhub-soft-purple py-6 text-lg"
